...
//    ListView lvChatBox;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listMessage.add(new ChatMessage("abc", "hello"));
        listMessage.add(new ChatMessage("abc", "hello"));
        listMessage.add(new ChatMessage("aqt3o4wu", "wqtbadznd"));
        listMessage.add(new ChatMessage("10010", "1111"));
        listMessage.add(new ChatMessage("kasjfiuaywOU", "A"));
        listMessage.add(new ChatMessage("AFSZSX", "asc"));
        listMessage.add(new ChatMessage("ZCZ", "szgfd"));
        listMessage.add(new ChatMessage("123", "abc"));
